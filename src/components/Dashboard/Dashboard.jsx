  ...
  return (
    <Fragment>
      <section className="section-dashboard px-3">
        ...
        <p className="info-text">
          <img
            ...
            alt="info-icon"
          />
          The times represented here are simulated times, based on the actions
          chosen. These represent work hours, not elapsed time.
        </p>
        {!loader && (
          <div className="row">
            <div className="col-12">
              <div className="summary-chart-wrapper my-3">
                <h3 className="section-title">
                  Total Time <span>(Cumalative)</span>
                </h3>
                <div className="row">
                  <div className="col-6">
            ...
            <div className="col-6">
              <div className="summary-details-wrapper">
                <div className="section-header">
                  <h3 className="section-title">
                    Findings <span className="count">12</span>
                  </h3>
                  <button
                        ...
                        <div className="row">
                          ...
                          <div className="col-8">
                            <div className="phase-summary-progress h-100">
                              {data.phase_summary_data.length > 0 &&
                                data.phase_summary_data.map(
                                  (dataEle, index) => (
                                    <Progressbar
                                      timeData={dataEle}
                                      key={data.id + dataEle.id}
                                      className="thin-bar"
                                    />
                                  )
                                )}
                          ...
                          <div className="col-1 action-wrapper">
                            <div
                              ...
                              onClick={($event) =>
                                handlePhaseActionClick($event, phaseIndex)
                              }
      ...
      <div
        ...
        id="phaseModal"
        tabIndex="-1"
        aria-labelledby="phaseModalLabel"
        aria-hidden="true"
      >
