...
function CompanyDetails () {
  ...
  const infoOptionList = [
    ...
    { optionValue: 'social security numbers', displayText: 'Social security numbers' },
    { optionValue: 'driver license number', displayText: 'Driver\'s license number' },
    { optionValue: 'healcare information', displayText: 'Healthcare information' },
    { optionValue: 'bank account numbers', displayText: 'Bank account numbers' },
    { optionValue: 'other', displayText: 'Other' }
  ]
    ...
    <div className="section-company-details">
      ...
      <form className="company-detail-form ">
        <div className="company-form-container c-font-14">
          <section className="left-container">
            <div className="custom-form-block mb-3">
              ...
              <div className="input-group has-validation">
                <input
                  ...
                  name="company_name"
                  id="company-name"
                  className={(companyForm.touched.company_name && companyForm.errors.company_name)
            ...
            <div className="custom-form-block mb-3">
              ...
              <div className="input-group has-validation">
                <input
                  ...
                  className={(companyForm.touched.admin_name && companyForm.errors.admin_name)
                    ? 'form-control is-invalid'
                    : 'form-control'}
            ...
            <div className="custom-form-block mb-3">
              ...
              <div className="c-radio-groups" role="group" aria-labelledby="company-BoD_group">
                {
                  bodOptionList.length > 0 && bodOptionList.map((optionData, index) => (
                    <div className="form-check form-check-inline" key={'bod_option_key_'+index}>
                      <input 
                        type="radio"
                        name="isBoD"
                      ...
                      <label className="form-check-label" htmlFor={'company-BoD_option'+index}>{optionData.displayText}</label>
                    </div>
                  ))
                }
              </div>
          ...
          <section className="right-container">
            <div className="custom-form-block mb-3">
              ...
              <div className="c-radio-groups" role="group" aria-labelledby="company-IM_group">
                {
                  imOptionList.length > 0 && imOptionList.map((optionData, index) => (
                    <div className="form-check form-check-inline" key={'im_option_key_'+index}>
                      <input 
                        type="radio"
                        name="im_name"
                        ...
                        onBlur={companyForm.handleBlur}
                        value={optionData.optionValue} />
                      <label className="form-check-label" htmlFor={'company-IM_option'+index}>{optionData.displayText}</label>
                    </div>
                  ))
                }
              </div>
            ...
            <div className="custom-form-block mb-3">
              ...
              <div className="c-radio-groups" role="group" aria-labelledby="company-SM_group">
                {
                  smOptionList.length > 0 && smOptionList.map((optionData, index) => (
                    <div className="form-check form-check-inline" key={'sm_option_key_'+index}>
                      <input 
                        type="radio"
                        name="sm_name"
                        ...
                        onBlur={companyForm.handleBlur}
                        value={optionData.optionValue} />
                      <label className="form-check-label" htmlFor={'company-SM_option'+index}>{optionData.displayText}</label>
                    </div>
                  ))
                }
              </div>
            ...
            <div className="custom-form-block mb-3">
              ...
              <div className="c-checkbox-groups" role="group" aria-labelledby="company-Info_group">
                {
                  infoOptionList.length > 0 && infoOptionList.map((optionData, index) => (
                    <div className="form-check form-check-inline" key={'info_option_key_'+index}>
                      <input 
                        type="checkbox"
                        name="info_types"
                        ...
                        onBlur={companyForm.handleBlur}
                        value={optionData.optionValue} />
                      <label className="form-check-label" htmlFor={'company-Info_option'+index}>{optionData.displayText}</label>
                    </div>
                  ))
                }
              </div>
        ...
        <div className="action-wrapper">
          <span>&nbsp;</span>
          <button type="submit" className="btn btn-primary btn-filled" onClick={companyForm.handleSubmit}>
            Save & Continue 
            <span className="icon-wrapper ps-2"><i className="fa-solid fa-arrow-right"></i></span>
          </button>
        </div>
      </form>
    </div>
